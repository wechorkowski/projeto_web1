...
/* Fixar somente a coluna "Nome" */
.tabela-exames th:first-child,
.tabela-exames td:first-child {
    position: sticky;
    left: 0;
    background-color:rgb(0, 0, 0);
    z-index: 3; /* maior que as outras células */
}
                ...
                <tbody>
                    ...
                    foreach ($alunos as $aluno):
                        ...
                        <tr class="<?= $apto ? 'linha-apto' : '' ?>">
                            <td class="col-cor"><?= htmlspecialchars($aluno['nome']) ?></td>
